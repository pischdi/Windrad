...
class ElevationService {
    ...
    /**
     * Get elevation from WMS GetFeatureInfo
     */
    async _getElevationFromWMS(x, y) {
        // This is a simplified approach
        // In reality, Brandenburg DOM WMS might not support GetFeatureInfo
        // Alternative: Download TIF and query locally
        
        // For now, use fallback
        throw new Error('WMS GetFeatureInfo not available, use fallback');
    }
